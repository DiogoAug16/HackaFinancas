...
struct TrackedItemVisualPicker: View {
    ...
    @Binding private var customSymbolName:
        String?
    ...
    private var symbolPicker: some View {
        VStack(alignment: .leading, spacing: 10) {
            Text(
                "Use o ícone da categoria ou escolha outro."
            )
            .font(.caption)
    ...
    private func invalidatePhotoImport() {
...
private enum ItemPhotoImportError: Error {
    case invalidImage
}
